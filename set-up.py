...
def main(
    prompt="A 4K close-up of a hummingbird mid-flight, its iridescent feathers shimmering as it feeds from a vibrant red flower, with a softly blurred background.",
    negative_prompt="",
    num_inference_steps=200,
    guidance_scale=4.5,
